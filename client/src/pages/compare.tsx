  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold" data-testid="text-page-title">Compare Bookmakers</h1>
        <p className="text-muted-foreground mt-1 text-sm sm:text-base">Side-by-side comparison of ratings, trust scores, and features</p>
      </div>
